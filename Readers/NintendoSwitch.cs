...
{
    static public class NintendoSwitch
    {
        const int PACKET_SIZE = 32;

        static readonly string[] BUTTONS = {
            "b", "a", "x", "y", "+", "-", "zl", "zr", "l", "r", "home", "capture", "ls", "rs", "up", "down", "left", "right"
        };
        ...
        static public ControllerState ReadFromPacket (byte[] packet)
        {
            ...
            state.SetAnalog ("rstick_x", readStick (SignalTool.readByte (packet, BUTTONS.Length    )));
            state.SetAnalog ("rstick_y", readStick (SignalTool.readByte (packet, BUTTONS.Length + 8)));            
