...
namespace LegacySpyPlus
{
    public class InputSource
    {
        ...
        static public readonly InputSource MD_GENESIS = new InputSource ("md_genesis", "MegaDrive_Genesis", true, false, port => new SerialControllerReader (port, MD_Genesis.ReadFromPacket));        
